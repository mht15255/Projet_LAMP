...
ALTER TABLE ES ADD CONSTRAINT FK_ES_ID_VEH FOREIGN KEY (ID_VEH) REFERENCES VEHICULE(ID_VEH);
...
ALTER TABLE AVEC ADD CONSTRAINT FK_AVEC_ID_NA FOREIGN KEY (ID_NA) REFERENCES TICKET_NA(ID_NA);
ALTER TABLE AVEC ADD CONSTRAINT FK_AVEC_ID_VEH FOREIGN KEY (ID_VEH) REFERENCES VEHICULE(ID_VEH);
